        ...
        if (res == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                if (m_App.getActiveCashDateEnd() == null) {
                    new StaticSentence(m_App.getSession(), "UPDATE CLOSEDCASH SET DATEEND = ? WHERE DATEEND IS NULL AND MONEY=?", new SerializerWriteBasic(new Datas[]{Datas.TIMESTAMP, Datas.STRING}))
                    ...
                    try {
                        ...
                        String body = "<html><table><tr><td colspan=\"8\">*REPORTE DE CIERRE DE CAJA " + config.getProperty("machine.hostname") + ".</td></tr><tr><td colspan=\"8\"><hr/></td></tr><tr><td colspan=\"2\">Secuencia:</td><td colspan=\"6\">" + this.m_PaymentsToClose.printSequence() + "</td></tr>" + "<tr><td colspan=\"2\">Fecha de inicio:</td><td colspan=\"6\">" + this.m_PaymentsToClose.printDateStart() + "</td></tr>" + "<tr><td colspan=\"2\">Fecha de fin:</td><td colspan=\"6\">" + Formats.TIMESTAMP.formatValue(dNow) + "</td></tr>" + "<tr><td colspan=\"8\"><hr/></td></tr><tr></tr>" + "<tr><td colspan=\"8\">*REPORTE DE PAGOS.</td></tr>" + "<tr><td colspan=\"8\"><hr/></td></tr>";

                        java.util.List<PaymentsModel.PaymentsLine> payments = this.m_PaymentsToClose.getPaymentLines();
                        for (int i = 0; i < payments.size(); i++) {
                            body = body + "<tr><td colspan=\"2\">" + ((PaymentsModel.PaymentsLine) payments.get(i)).printType() + "</td><td colspan=\"6\">" + ((PaymentsModel.PaymentsLine) payments.get(i)).printValue() + "</td></tr>";
                        }
                        body = body + "<tr><td colspan=\"2\">TOTAL:</td><td colspan=\"6\">" + m_jCash.getText() + "</td></tr>";

                        body = body + "<tr><td colspan=\"8\"><hr/></td></tr><tr></tr><tr><td colspan=\"8\">*REPORTE DE PRODUCTOS VENDIDOS.</td></tr><tr><td colspan=\"8\"><hr/></td></tr>";
                        body = body + "<tr><td>TICK</td><td>FECHA</td><td>PRODUCTO</td><td>MENSUALIDAD</td><td>ID CTE</td><td>CLIENTE</td><td>TOTAL</td><td>USUARIO</td></tr>";
                        ...
                        for (int i = 0; i < productSales.size(); i++) {
                            total += ((PaymentsModel.ProductSalesLine) productSales.get(i)).getTotal();
                            body = body + "<tr><td>" + ((PaymentsModel.ProductSalesLine) productSales.get(i)).printTicket()+ "</td><td>" + ((PaymentsModel.ProductSalesLine) productSales.get(i)).printFecha()+ "</td><td>" + ((PaymentsModel.ProductSalesLine) productSales.get(i)).printProductName()+ "</td><td>" + ((PaymentsModel.ProductSalesLine) productSales.get(i)).printMensualidad()+ "</td><td>" + ((PaymentsModel.ProductSalesLine) productSales.get(i)).printIdCte()+ "</td><td>" + ((PaymentsModel.ProductSalesLine) productSales.get(i)).printCte()+ "</td><td>" + ((PaymentsModel.ProductSalesLine) productSales.get(i)).printTotal()+ "</td><td>" + ((PaymentsModel.ProductSalesLine) productSales.get(i)).printUsuario()+ "</td></tr>";
                        }
                        body = body + "<tr><td colspan=\"2\">TOTAL:</td><td colspan=\"6\">" + Formats.CURRENCY.formatValue(total).trim() + "</td></tr>";
                        ...
                        */
                        body = body + "<tr><td colspan=\"8\"><hr/></td></tr><tr></tr><tr><td colspan=\"8\">REPORTE DE ENTRADAS/SALIDAS.</td></tr><tr><td colspan=\"8\"><hr/></td></tr>";
                        
                        java.util.List<PaymentsModel.PaymentMovements> pm = this.m_PaymentsToClose.getPaymentMovements();
                        for (int i = 0; i < pm.size(); i++) {
                            body = body + "<tr><td colspan=\"2\">" + ((PaymentsModel.PaymentMovements) pm.get(i)).printType()+ "</td><td colspan=\"2\">" + ((PaymentsModel.PaymentMovements) pm.get(i)).printValue() + "</td><td colspan=\"4\">" + ((PaymentsModel.PaymentMovements) pm.get(i)).printType2() + "</td></tr>";
                        }
