...
public class JProductLineEdit extends javax.swing.JDialog {
    ...
    private TicketLineInfo init(AppView app, TicketLineInfo oLine) throws BasicException {
        ...
        m_jName1.setText(oLine.printMensualidad());
    ...
    private void initComponents() {
        ...
        m_jName1.setBounds(100, 110, 270, 25);
    ...
    private void m_jButtonOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jButtonOKActionPerformed
        m_oLine.setProperty("mensualidad", m_jName1.getText());
        m_oLine.setMensualidad(m_jName1.getText());
        returnLine = m_oLine;
