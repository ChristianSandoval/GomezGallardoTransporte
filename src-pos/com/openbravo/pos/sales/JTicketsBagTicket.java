...
import com.openbravo.pos.panels.JTicketsFinder2;
...
public class JTicketsBagTicket extends JTicketsBag {
    ...
    private void initComponents() {
        ...
        jButton3.setText(AppLocal.getIntString("label.search")); // NOI18N
...
private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        JTicketsFinder finder = JTicketsFinder.getReceiptFinder(this, m_dlSales, dlCustomers, m_App.getInventoryLocation());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        JTicketsFinder2 finder = JTicketsFinder2.getReceiptFinder(this, m_dlSales, dlCustomers,m_dlSystem, m_App.getDeviceTicket());
        finder.setVisible(true);
        FindTicketsInfo selectedTicket = finder.getSelectedCustomer();
